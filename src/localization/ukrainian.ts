...
export var uaStrings = {
  //survey templates
  survey: {
    edit: "Відредагувати",
    dropQuestion: "Будь ласка, перенесіть питання з панелі інструментів вліво.",
    copy: "Копіювати",
    addToToolbox: "Додати до панелі інструментів",
    deletePanel: "Видалити панель",
    deleteQuestion: "Видалити питання",
    convertTo: "Конвертувати",
    drag: "Перенести елемент"
  },
  //questionTypes
  qt: {
    default: "Default",
  ...
  ed: {
    survey: "Тест",
    settings: "Налаштування тесту",
    editSurvey: "Редагувати тест",
    addNewPage: "Додати нову сторінку",
    moveRight: "Змістити вліво",
    moveLeft: "Змістити вправо",
    ...
    newPanelName: "панель",
    testSurvey: "Перегляд тесту",
    testSurveyAgain: "Снову перегляд тесту",
    testSurveyWidth: "Survey width: ",
    embedSurvey: "Embed Survey",
    saveSurvey: "Зберегти тест",
    designer: "Редактор тесту",
    ...
    toolbox: "Toolbox",
    toolboxGeneralCategory: "Основні",
    delSelObject: "Видалити вибраний об'єкт",
    editSelObject: "Редагувати вибраний об'єкт",
    correctJSON: "Будь ласка, виправте JSON.",
    surveyResults: "Результат тесту: ",
    modified: "Змінено",
    saving: "Зберігається",
    saved: "Збережено"
  },
  ...
  pel: {
    isRequired: "Необхідний параметр?"
  },
  //Property Editors
  pe: {
    apply: "Apply",
    ...
    delete: "Видалити",
    addNew: "Додати новий",
    addItem: "Нажміть для того, аби додати складову...",
    removeAll: "Видалити все",
    edit: "Редагувати",
    itemValueEdit: "Видимий, якщо",
    editChoices: "Змінити поля вибору",
    move: "Рухатися",
    empty: "<empty>",
    notEmpty: "<edit value>",
    ...
    conditionValueQuestionTitle: "Введіть або виберіть значення",
    conditionButtonAdd: "Додати",
    conditionButtonReplace: "Замінити",
    conditionHelp:
    ...
    propertyIsEmpty: "Введіть значення",
    value: "Значення",
    text: "Текст",
...
editorLocalization.locales["ua"] = uaStrings;
